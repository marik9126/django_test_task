...
SECRET_KEY = '84w$w44sa9p4-zi#=_=f_^-a6q8^f0vde*uo1+6b_zsk(powg4'
...
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR , '../testtask/templates'),
)
...
FACEBOOK_APP_ID = '163055320568715'
FACEBOOK_API_SECRET = 'f44dca33f67386b5817900eae4def11a'
